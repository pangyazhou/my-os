...
===========================================================================*/
/**
* <Ring 1> Open a file and return the file descriptor.
*
...
PUBLIC int do_open()
{
	...
	/* find a free slot in PROCESS::flip[] */
	int i;
...
===========================================================================*/
/**
* <Ring 1> Create a file and return it's inode ptr.
*
...
===========================================================================*/
/**
* <Ring 1> Handler the close message.
*
...
PUBLIC int do_lseek()
{
	...
	int f_size = pcaller->flip[fd]->fd_inode->i_size;
...
===========================================================================*/
/**
* <Ring 1> Allocate a bit in inode-map.
*
		...
		for(j = 0; j < SECTOR_SIZE & nr_sects_to_alloc > 0; j++)
		{
			...
			if(!free_sect_nr)
			{
				if(fsbuf[j] == 0xff)
					continue;
				for(; ((fsbuf[j] >> k) & 1) != 0; k++){}
				free_sect_nr = (i * SECTOR_SIZE + j) * 8 + k - 1 +
								sb->n_1st_sect; 
			}
			for(; k < 8; k++)
			{
